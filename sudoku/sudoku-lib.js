...
;(function(){
    ...
    var MIN_GIVENS = 10; // Minimum number of givens 
    ...
    sudoku.generate = function(difficulty, unique) {
        ...
        `difficulty` must be a number between 10 and 81 inclusive. If it's
        ...
        */
        ...
        // Force difficulty between 10 and 81 inclusive
    ...
    window.playtouchGame.main = sudoku;
})();