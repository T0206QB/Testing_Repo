...
///////////////////////////////////////////////////////////
    ...
    Board.prototype.boardLog = function(command, cellID1, cellID2, tileID1, tileID2) {
        ...
        switch (command) {
            ...
            case "create":
                ...
                this.changeLog.create.push(
                                            ...
                                            "tileID": (this.getTileAt(cellID1)).getId()
                                            }
                                            );
                break;
    ...
    Board.prototype.moveTileToCell = function(moveArray){
        ...
        if (!tileAtDestination.isGhost()) {
            ...
            this.boardLog("swapTiles", originCellID, destinationCellID, tileAtOrigin.getId(), tileAtDestination.getId());

        }else{

        	this.addTileToCell(destinationCellID,tileAtOrigin);
        	this.boardLog("posChange", destinationCellID, originCellID, tileAtOrigin.getId());
        } 
